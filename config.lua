...
Config.Locations = {
      -- Tienda pokemon
      ["marketshop"] = {
        ["label"] = "Buy Pokemon Cards2",
        ["coords"] = vector4(-140.27, 223.96, 94.99, 88.72), --or vector4(-659.87, -936.46, 21.83, 130.04), --  for mlo https://www.gta5-mods.com/maps/
        ["ped"] = 'S_M_M_StrVend_01',
        ["scenario"] = "WORLD_HUMAN_COP_IDLES",
        ["radius"] = 5.5,
        ["targetIcon"] = "Fas Fa-Globe",
        ["targetLabel"] = "Buy Pokemon Cards2",
        ["products"] = Config.Products["marketshop"],
        ["showblip"] = true,
        ["blipsprite"] = 267,
        ["blipcolor"] = 5
    },
    ...
    ["petshop"] = {
        ["label"] = "Pet Shop",
        ["coords"] = vector4(564.9, 2748.63, 42.88, 82.06), --or vector4(-659.87, -936.46, 21.83, 130.04), --  for mlo https://www.gta5-mods.com/maps/
        ["ped"] = 'S_M_M_StrVend_01',
        ["scenario"] = "WORLD_HUMAN_COP_IDLES",
        ["radius"] = 1.5,
